...
This project uses a standard [Makefile](https://en.wikipedia.org/wiki/Make_%28software%29)
to build a project that can be loaded onto the pico-ice board.
...
Build with `make` and deploy it to the pico-ice with `sudo make prog`, and `make blink.uf2` to generate an
